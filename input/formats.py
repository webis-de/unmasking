    ...
    def __iter__(self) -> Iterable[SamplePair]:
        ...
        for cls1 in texts_by_class:
            ...
            for cls2 in texts_by_class:
                ...
                while chunk_counter < self._samples and len(drawn1) < num_texts1 and len(drawn2) < num_texts2 > 0:
                    ...
                    if chunk_counter < self._samples // 2 and len(drawn1) >= num_texts1:
                        drawn1 = []
                    elif chunk_counter < self._samples // 2 and len(drawn2) >= num_texts2:
                        drawn2 = []
